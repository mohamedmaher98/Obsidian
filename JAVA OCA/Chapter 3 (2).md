...
- ال**Strings** هي تسلسلات ثابتة من الأحرف (immutable). هذا يعني أنه لا يمكن تعديل الكائن بعد إنشائه.
...
- ال**String Pool**: يتم تخزين String literals في **String pool** لتقليل استهلاك الذاكرة وتحسين الأداء.
...
-ال **StringBuilder**: هي تسلسلات متغيرة من الأحرف (mutable). يمكن تعديل النصوص في الكائن دون الحاجة لإنشاء كائن جديد.
    
    -ال **StringBuffer**: نفس **StringBuilder** ولكن **Thread-safe** (آمن لاستخدامه في بيئة متعددة الخيوط).
...
- ال**Arrays**: هي مناطق ثابتة من الذاكرة على heap تحتوي على بيانات من نوع معين (مثل int[] أو String[]).
    
    ال- **Arrays.sort()**: لترتيب المصفوفات.
        
    ال- **Arrays.binarySearch()**: للبحث في مصفوفة مرتبة.
...
- **طرق مهمة للعمل مع Dates**:
    ...
    - ال**Period**: تمثل فترة زمنية يمكن إضافتها أو خصمها من **LocalDate** أو **LocalDateTime**.
        
    -ال **DateTimeFormatter**: لتنسيق التاريخ والوقت بالطريقة المطلوبة.
